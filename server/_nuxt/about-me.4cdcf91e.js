...
import { _ as _imports_1$2, a as _imports_0$1 } from "./arrow.13000919.js";
import "destr";
import "ofetch";
...
import "defu";
import "aos";
const CommentedText_vue_vue_type_style_index_0_lang = "";
const _sfc_main$2 = {
  props: {
    text: {
      type: String,
...
const GistSnippet_vue_vue_type_style_index_0_lang = "";
const _sfc_main$1 = {
  name: "GistSnippet",
  props: {
    id: {
...
const aboutMe_vue_vue_type_style_index_0_lang = "";
const _sfc_main = {
  data() {
    return {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (!$data.loading) {
    ...
    _push(`<!--]--></div><div id="section-content" class="hidden lg:block w-full h-full border-right"><div id="section-content-title" class="hidden lg:flex items-center min-w-full"><img id="section-arrow-menu"${ssrRenderAttr("src", _imports_0$1)} alt="" class="section-arrow mx-3 open"><p class="font-fira_regular text-white text-sm">${$setup.config.dev.about.sections[$data.currentSection].title}</p></div><div><!--[-->`);
    ...
    _push(`<!--]--></div><div id="section-content-title-contact" class="flex items-center min-w-full border-top"><img id="section-arrow-menu"${ssrRenderAttr("src", _imports_0$1)} alt="" class="section-arrow mx-3 open"><p class="font-fira_regular text-white text-sm">${$setup.config.dev.contacts.direct.title}</p></div><div id="contact-sources" class="hidden lg:flex lg:flex-col my-2"><!--[-->`);
    ssrRenderList($setup.config.dev.contacts.direct.sources, (source, key) => {
      _push(`<div class="flex items-center mb-2"><img${ssrRenderAttr("src", "/icons/" + key + ".svg")} alt="" class="mx-4"><a href="/" class="font-fira_retina text-menu-text hover:text-white">${source}</a></div>`);
    });
    ...
    _push(`<!--]--><div id="section-content-title" class="flex items-center min-w-full"><img${ssrRenderAttr("src", _imports_0$1)} alt="" id="section-arrow" class="section-arrow"><p class="font-fira_regular text-white text-sm">${$setup.config.dev.contacts.direct.title}</p></div><div id="contacts" class="hidden"><!--[-->`);
    ssrRenderList($setup.config.dev.contacts.direct.sources, (source, key) => {
    ...
    ssrRenderList($setup.config.public.dev.gists, (gist, key) => {
...
//# sourceMappingURL=about-me.4cdcf91e.js.map
