import { _ as _export_sfc, a as __nuxt_component_0$1, u as useRuntimeConfig } from "../server.mjs";
...
const SnakeGame_vue_vue_type_style_index_0_lang = "";
const _sfc_main$1 = {
  data() {
    return {
      score: 0,
...
const index_vue_vue_type_style_index_0_scoped_4dfbe58c_lang = "";
const _sfc_main = {
  __name: "index",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!loading.value) {
        _push(`<main${ssrRenderAttrs(mergeProps({ id: "hello" }, _attrs))} data-v-4dfbe58c><div class="css-blurry-gradient-blue" data-v-4dfbe58c></div><div class="css-blurry-gradient-green" data-v-4dfbe58c></div><section class="hero" data-v-4dfbe58c><div class="head" data-v-4dfbe58c><span data-v-4dfbe58c> Hi all, I am </span><h1 data-v-4dfbe58c>${ssrInterpolate(unref(config).dev.name)}</h1><span class="diple flex" data-v-4dfbe58c> &gt;\xA0 <h2 class="line-1 anim-typewriter max-w-fit" data-v-4dfbe58c>${ssrInterpolate(unref(config).dev.role)}</h2></span></div><div id="info" data-v-4dfbe58c><span class="action" data-v-4dfbe58c> // complete the game to continue </span><span class="${ssrRenderClass({ hide: isMobile.value })}" data-v-4dfbe58c> // you can also see it on my Github page </span><span class="${ssrRenderClass({ hide: !isMobile.value })}" data-v-4dfbe58c> // find my profile on Github: </span><p class="code" data-v-4dfbe58c><span class="identifier" data-v-4dfbe58c> const </span><span class="variable-name" data-v-4dfbe58c> githubLink </span><span class="operator" data-v-4dfbe58c> = </span><a class="string"${ssrRenderAttr("href", "https://github.com/" + unref(config).public.dev.contacts.social.github.user)} data-v-4dfbe58c> &quot;https://github.com/${ssrInterpolate(unref(config).public.dev.contacts.social.github.user)}&quot; </a></p></div></section>`);
        if (!isMobile.value) {
          _push(`<section data-aos="fade-up" class="game" data-v-4dfbe58c>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4dfbe58c"]]);
export {
  index as default
};
//# sourceMappingURL=index.82cf4f68.js.map
